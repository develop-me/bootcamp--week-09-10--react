...
\js{}{04-hooks/figures/01-class-component}

And here it is using hooks:

\js{}{04-hooks/figures/02-hooks}
...
\js{}{04-hooks/figures/03-multiple-useState}
...
\js{}{04-hooks/figures/04-reducer-id}
...
\js{}{04-hooks/figures/05-reducer-p1scores}
...
\js{}{04-hooks/figures/06-reducer-pull}
...
\js{}{04-hooks/figures/07-reducer-payload}
...
\js{}{04-hooks/figures/08-useReducer}
...
\js{}{04-hooks/figures/09-useEffect}
...
\js{}{04-hooks/figures/10-useEffect-dependents}
...
\js{}{04-hooks/figures/13-useGetArticles}
...
\js{}{04-hooks/figures/14-Articles}
...
\begin{infobox}{Under the Hook}
    ...
    \js{}{04-hooks/figures/15-under-the-hood}
