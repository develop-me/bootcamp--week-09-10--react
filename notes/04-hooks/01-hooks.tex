...
Say we wanted to keep track of lots of different player scores. It would be nice to be able to just have a single action and say \textit{which} player has scored:\footnote{This can be made even shorter using ``Computed Property Names''}
