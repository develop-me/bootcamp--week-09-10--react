...
\js{src/Header.js}{02-jsx/figures/03-Header}

Now update \texttt{App} to include our Header component:

\js{src/App.js}{02-jsx/figures/04-App-with-Header}
...
\js{src/App.js}{02-jsx/figures/05-App-with-Fishsticks}
...
\js{src/Content.js}{02-jsx/figures/06-Content}

Let's update it so we can easily change the amount of money:

\js{src/Content.js}{02-jsx/figures/07-Content-with-JS}
...
\js{src/App.js}{02-jsx/figures/08-Content-in-App}
...
\js{src/App.js}{02-jsx/figures/09-React.Fragment}

Fragments are so useful that there's a shorthand for it:

\code{src/App.js}{html}{02-jsx/figures/10-React.Fragment-shorthand.js}
...
\js{src/Funding.js}{02-jsx/figures/11-Funding}

And now update \texttt{<Content>} to use the new component:

\js{src/Content.js}{02-jsx/figures/12-Content-with-Funding}
...
\begin{infobox}{JSX or JS?}
    ...
    \js[frame=topline]{}{02-jsx/figures/14-JSX-JS-context}
\end{infobox}
...
\js{}{02-jsx/figures/15-map-objects}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \href{https://www.joshwcomeau.com/css/styled-components/}{The styled-components happy path}: tool for managing CSS in React apps
