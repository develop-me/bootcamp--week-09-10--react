...
\js{}{02-jsx/figures/03-Header}

Now update \texttt{App} to include our Header component:

\js{}{02-jsx/figures/04-App-with-Header}
...
\js{}{02-jsx/figures/05-App-with-Fishsticks}
...
\js{}{02-jsx/figures/06-Content}

Let's update it so we can easily change the amount of money:

\js{}{02-jsx/figures/07-Content-with-JS}
...
\js{}{02-jsx/figures/08-Content-in-App}
...
\js{}{02-jsx/figures/09-React.Fragment}
...
\code{}{html}{02-jsx/figures/10-React.Fragment-shorthand.js}
...
\js{}{02-jsx/figures/11-Funding}

And now update \texttt{<Content>} to use the new component:

\js{}{02-jsx/figures/12-Content-with-Funding}
