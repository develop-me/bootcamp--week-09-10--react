...
\inputminted{js}{01-one-way-data-flow/figures/01-Button.jsx}
...
\inputminted{js}{01-one-way-data-flow/figures/02-Buttons.jsx}


Next we'll update the \texttt{<Buttons>} component to pass down the value of \texttt{selected} to \texttt{<Button>} using a prop:

\inputminted{js}{01-one-way-data-flow/figures/03-Buttons-selected.jsx}
...
\inputminted{js}{01-one-way-data-flow/figures/04-Button-selected.jsx}
...
\inputminted{js}{01-one-way-data-flow/figures/05-Buttons-click.jsx}
...
\inputminted{js}{01-one-way-data-flow/figures/06-Button-func.jsx}
