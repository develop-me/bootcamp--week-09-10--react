...
If we forget to do this, over the life of our app the multiple copies of the same event listener will build up, using memory and CPU unnecessarily (and potentially leading to all sorts of weird bugs).
