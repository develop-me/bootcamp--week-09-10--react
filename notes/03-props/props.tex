...
\js{src/Figure.js}{03-props/figures/01-Figure}
...
\code{}{js}{03-props/figures/02-Figure-usage.html}
...
\js{src/Figure.js}{03-props/figures/03-Figure-props}
...
\begin{infobox}{Destructuring Props}
    ...
    \js{}{03-props/figures/04-Figure-destructure}
...
\html{}{03-props/figures/05-Figure-multi}
...
\js{src/Header.js}{03-props/figures/06-Header}
...
\end{minted}
\begin{minted}[frame=bottomline]{js}
    <Thing blah={ x } />
\end{minted}
...
\js{src/Header.js}{03-props/figures/07-Header-ternary}
...
\js{src/Header.js}{03-props/figures/08-Header-children}
...
\js{src/Figure.js}{03-props/figures/09-default-props}
